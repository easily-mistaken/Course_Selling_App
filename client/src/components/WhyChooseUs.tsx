...
const whychooseus = [
  ...
  },
  {
    ...
    description:
      "Helping you understand the basics how version control is implemented in the industry",
  },
  {
    id: 6,
    value: "06",
  ...
  return (
    <>
      <div className="flex flex-col mt-32 md:mt-44 ">
        <h1 className="text-white text-[30px] md:text-[44px] font-bold font-['Poppins'] leading-[70.40px]">
          Why choose Us
        </h1>
        ...
        {whychooseus.map((val, index) => (
          <div
            ...
            style={{
              boxShadow:
                "0 2px 2px rgba(222, 249, 250, 0.5), 0 8px 25px rgba(190, 243, 245, 0.4), 0 12px 35px rgba(51, 187, 207, 0.3)",
            }}
          ...
          >
            <div className="flex flex-row justify-between items-center ">
              <div className="flex flex-row gap-6 sm:gap-10 items-center">
                <h1 className="text-white text-2xl sm:text-6xl font-medium ">
                  {val.value}
                </h1>
                <h3 className="text-white text-lg sm:text-3xl font-medium">
                  {val.title}
                </h3>
              </div>
              {/* <Plus />  */}
              ...
              >
                {isOpen[val.id] ? (
                  <Minus className="sm:size-9" />
                ) : (
                  <Plus className=" sm:size-9" />
                )}
              </div>
            </div>
            ...
            {isOpen[val.id] && (
              <div className="flex flex-col gap-10">
                ...
                <p className="mb-4 text-white text-sm sm:text-lg font-normal ">
                  {val.description}
                </p>
              </div>
            )}
